...
public class ExtraCreditWeekOneApplication {
	...
	public static void readProject() {
		...
		for (Project project : projects) {
			System.out.println(String.format("%1$10s %2$10s %3$10s %4$10s", project.getName(), project.getDescription(),
					project.getStart_date().toString(), project.getStatus().toString()));
		}

		List<Project> projects1 = volunteerService.searchProjectByStatus(Status.PENDING);
